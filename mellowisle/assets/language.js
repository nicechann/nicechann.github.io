(() => {
  ...
  const storageKey = "mellowisle-language";
  ...
  function setLanguage(language, shouldPersist = true) {
    ...
    const title = document.body.dataset[`title${nextLanguage.toUpperCase()}`];
    const description = document.body.dataset[`description${nextLanguage.toUpperCase()}`];
